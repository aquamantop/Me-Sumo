...
test('Desde club - crear un evento con usuario logueado', async ({ page }) => {
  ...
  await expect(page.getByRole('heading', { name: 'Futbol Retiro | Padre Carlos' })).toBeVisible();
  ...
  await expect(page.getByText('Servicios del ClubEstacionamientoParrillaBarVestuarioRestauranteWi-FiAyuda Mé')).toBeVisible();
