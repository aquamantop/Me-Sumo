...
/*      useEffect(() => {
     ...
     const handleInputChange = (fieldName) => (event, value) => {
        ...
        if (fieldName === 'activities') {
            // const selectedActivityKey = Object.keys(activities).find(key => activities[key] === fieldValue);
        ...
        if (fieldName === 'amenity') {
            //const selectedAmenityKey = Object.keys(amenities).find(key => amenities[key] === fieldValue);
            // console.log("Amenity")
            ...
            //const lista = fieldValue.map(item => Object.keys(amenities).find(key => amenities[key] === item))
            //console.log(lista)
